...
docstring:  <br/>
        - purpose: create instance of class die <br/>
        - param: <list> of faces on die <br/>
        - return: None <br/>

atributes: <br/>
        - die_object.faces = a list of faces belonging to the die object  <br/>
        - die_object.weights = a list of weights corresponding to die object faces  <br/>
...
docstring:  <br/>
        - purpose: change weight given to a face of die in roll  <br/>
        - param1: <string, int, float> face to weight  <br/>
        - param2: <int or float> weight to be given to face  <br/>
        - return: None  <br/>
...
docstring:  <br/>
        - purpose: return a random face of die with condiseration to weights  <br/>
        - param: <int >number of rolls  <br/>
        - return: <list> face values  <br/>
...
docstring:  <br/>
        - purpose: user can see faces and weights of die instance  <br/>
        - return: dataframe  <br/>
...
docstring:  <br/>
        - purpose: create and isntance of a game <br/>
        - param: <list of class die> , all dice must have same number of faces  <br/>
        - return: None <br/>

atributes: <br/>
        - game_object.die_object = references the die with name die_object within game object, this allows you to (for example) display the properites of the die or change it's weight after the game object is created.  <br/>
        - game_object.die_list = the original list of dice passed into the game object  <br/>
...
docstring:  <br/>
        purpose: roll each die in game a number of times and imput face values into global dataframe  <br/>
        param: <int> number of rolls  <br/>
        return: None  <br/>
...
docstring:  <br/>
        purpose: display results of play function to user  <br/>
        param: <bool> indicating wide or narrow, defaults to wide  <br/>
        return: dataframe  <br/>
...
docstring:  <br/>
        purpose: create and instance of analyzer class  <br/>
        param: instance of class game  <br/>
        return: None  <br/>
    
attributes:  <br/>
        self.game = game object passed in  <br/>
        self.data_type = shows the data type of the faces of dice rolled in game.play  <br/>
        self.jpdf = dataframe of jackpots  <br/>
        self.freq_sdf = frequency oriented dataframe of sequences  <br/>
        self.sdf = sequence oriented dataframe of sequences  <br/>
        self.freq_cdf = frequency oriented dataframe of combinations  <br/>
        self.cdf = combination oriented dataframe of combinations  <br/>
        self.countsdf = dataframe of the face counts of each roll  <br/>
...
docstring:  <br/>
        purpose: counts the number of rolls in game all dices showed an identical face  <br/>
        return: <int> number of occurances  <br/>
...
docstring:  <br/>
        purpose: method to compute the number of distinct sequences of faces rolled  <br/>
        param: freq=True/False to sort by frequency or not, defaults to false  <br/>
        return: dataframe  <br/>
...
docstring:  <br/>
        purpose: method to compute a dataframe of distinct combinations of faces rolled  <br/>
        param: freq = True/False to sort by frequency or not, defaults to false  <br/>
        return: dataframe  <br/>
...
docstring:  <br/>
        purpose: method to compute how many times a given face is rolled in each event  <br/>
        return: dataframe  <br/>
